...
def ping_api(url: str, timeout: int = 8):
...
API_TIMEOUT_SECONDS = 45  # bump this if your bypass API is slow / times out often


def call_bypass_api(url: str, timeout: int = API_TIMEOUT_SECONDS):
